    ...
    <div class="d-flex">
        <nav class="bg-dark text-white p-3 vh-100" style="width: 250px;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a href="{{ route('kategori.index') }}" class="nav-link text-white"><i class="fas fa-tags me-2"></i> Kategori Alat</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('alat.index') }}" class="nav-link text-white"><i class="fas fa-microscope me-2"></i> Alat Riset</a>
                </li>
                @endif
