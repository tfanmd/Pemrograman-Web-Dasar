                ...
                <div class="col-md-8 mb-3">
                    ...
                    <select class="form-select" id="alat_id" name="alat_id" required>
                        ...
                        @foreach($alat as $item)
                            <option value="{{ $item->id }}">{{ $item->nama_alat }} (Sisa Stok: {{ $item->stok }})</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="jumlah_pinjam" class="form-label">Jumlah Pinjam</label>
                    <input type="number" class="form-control" id="jumlah_pinjam" name="jumlah_pinjam" min="1" value="1" required>
                </div>
            </div>
